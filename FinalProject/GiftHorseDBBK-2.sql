...
INSERT INTO `customer` VALUES (0001,'Jennifer','Diederich','309 Washington St','Stanley','WI',54768),(0002,'Marge','Feigum','15 Bittersweet Way','Englewood','WI',54766),(0003,'Thom','Manion','88 Ridgeway Ct','Chilton','WI',54744),(0004,'Alexandra','Gee','1212 Main St','Wales','WI',54745),(0005,'Christine','Flowers','841 Ribbon Dr','Heartland','WI',55212);
...
INSERT INTO `orderline` VALUES (100399,'g03',1,65.00),(100399,'w01',1,45.99),(100400,'s04',1,40.00),(100400,'w01',1,45.99),(100422,'g01',1,75.25),(100422,'w02',1,45.99),(100426,'s04',3,40.00),(100500,'s03',1,39.99),(100500,'s04',2,40.00),(100555,'s03',2,39.99);
...
CREATE TABLE `orders` (
  ...
  `ShipDate` date DEFAULT '0000-00-00',
  `ShipToCustFName` varchar(15) NOT NULL,
  `ShipToCustLName` varchar(15) NOT NULL,
  `ShipToCustAddr` varchar(45) NOT NULL,
  `ShipToCustCity` varchar(15) NOT NULL,
  `ShipToCustState` varchar(2) NOT NULL,
  `ShipToCustZip` int(5) NOT NULL,
  PRIMARY KEY (`OrdID`),
...
INSERT INTO `orders` VALUES (100399,0002,'2013-12-06','2013-12-06','2013-12-07','Anna Louise','Feigum','15 East Main St','Baltimore','MD',45678),(100400,0003,'2013-12-06','2013-12-06','2013-12-07','Bernie','Gates','2000 Ironway Rd. Apt 12','St. Paul','MN',67000),(100422,0002,'2013-12-11','2013-12-11','2013-12-12','Bob','Cameron','13556 Shady Pine Drive','Plattville','WI',70098),(100426,0004,'2013-02-16','2013-02-16','2013-02-17','Tamara','Gee','20 Windsow Woods Dr','St. Paul','MN',67033),(100500,0001,'2012-04-15','2012-04-15','2012-04-16','Olya','Diederich','1010 Milam St','Houston','Tx',42455),(100555,0001,'2017-10-18','2017-10-18','0000-00-00','Heather','Wilkes','151 Rum River Rd','Plainter','WI',52588);
...
-- Dump completed on 2017-10-21 18:11:39
